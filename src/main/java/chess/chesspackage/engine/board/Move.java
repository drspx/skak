...
import chess.chesspackage.engine.board.Board.Builder;
import chess.chesspackage.engine.pieces.Pawn;
...
public abstract class Move {
    ...
    private Move(final Board board, int destinationCoordinate) {
        this.board = board;
    ...
    public static final class PawnPromotion extends Move {
        ...
        public PawnPromotion(final Move decoratedMove) {
            super(decoratedMove.getBoard(), decoratedMove.movedPiece, decoratedMove.getDestinationCoordinate());
    ...
    static abstract class CastleMove extends Move {
        ...
        public Board execute() {
            ...
            //TODO look into first move for normal chesspackage.engine.piece
            builder.setMoveMaker(this.board.currentPlayer().getOpponent().getAlliance());
            return builder.build();
        }
